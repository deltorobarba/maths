...
Machine Learning and Quantum Computing engineer at Google Cloud. Working with Cloud customers on strategizing and implementing large-scale, innovative machine learning on Google Cloud infrastructure. Besides, I worked hard to move academically from economics to quantum algorithms with publications on international scientific journals.
...
#### Nature
* Thermalization and Criticality on an Analog-Digital Quantum Simulator (2025)
* Demonstrating dynamic surface codes (2025)
* Phase transitions in random circuit sampling (2024)
* Non-Abelian braiding of graph vertices in a superconducting processor (2023)
* Measurement-induced entanglement and teleportation on a noisy quantum processor (2023)
